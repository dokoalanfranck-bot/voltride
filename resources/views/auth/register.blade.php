...
<body>
    <div class="register-card w-full max-w-md mx-4 px-8 py-12">
        <div class="text-center mb-8">
            ...
            <h2 style="font-size: 1.5rem; font-weight: 700; color: #1f7550; margin-bottom: 8px;">Inscription</h2>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div>
                <label style="display: block; font-weight: 600; color: #1f7550; margin-bottom: 8px;">Nom complet</label>
            ...
            <div>
                <label style="display: block; font-weight: 600; color: #1f7550; margin-bottom: 8px;">Confirmer le mot de passe</label>
